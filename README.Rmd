...
Finally, you can use `searchdem` to find specific indicators or all of the indicators used to construct an index. For example, we can use `searchdem("civil liberties"` to find all of the indicators used to construct the civil liberties index. `searchdem()` without any arguments produces a searchable HTML table of all indicators in the dataset. 
